---
layout: post
title: "#16 - Oiled Oak Dovetails 5B2"
date: 2022-10-16 20:00:00 -0500
categories: amps
image: https://wernull.com/images/16/IMG_7620.jpg
featured: true
description: "An early-1950s Fender Princeton 5B2 circuit in a dovetailed cabinet made from a twenty-year-old oak board, driving a 6x9 speaker pulled from a 1970s Leslie organ. The chassis was bent from scrap sheet metal and finished in layered powder coat with vinyl-cut decals."
# NAM Capture Player — one 120 BPM / 8-section solo-guitar take reamped through each
# model. Replace the src URLs once the .m4a files are produced and uploaded to S3.
nam_player:
  bpm: 120
  sections: 8
  bars_per_section: 4
  leadIn: 0            # 0 = auto-detect AAC encoder priming
  tracks:
    - name: "Princeton 5B2 — clean"
      src: https://wernull.com/audio/amp16/5b2-clean.m4a
    - name: "Princeton 5B2 — edge"
      src: https://wernull.com/audio/amp16/5b2-edge.m4a
    - name: "Princeton 5B2 — cranked"
      src: https://wernull.com/audio/amp16/5b2-cranked.m4a
---
...
I captured a few NAM models of the amp at different settings. Pick a capture and toggle the sections to loop the part that interests you — it stays on beat as you switch.

{% include nam-player.html %}
